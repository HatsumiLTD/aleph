...
AFRAME.registerComponent("al-cursor", {
  ...
  init: function() {
    ...
    // Debounce.
    this.updateCanvasBounds = (AFRAME.utils as any).debounce(
    ...
    // Bind methods.
    this.onCursorDown = (AFRAME.utils as any).bind(this.onCursorDown, this);
    this.onCursorUp = (AFRAME.utils as any).bind(this.onCursorUp, this);
    this.onIntersection = (AFRAME.utils as any).bind(this.onIntersection, this);
    this.onIntersectionCleared = (AFRAME.utils as any).bind(
      this.onIntersectionCleared,
      this
    );
    this.onMouseMove = (AFRAME.utils as any).bind(this.onMouseMove, this);
  },
